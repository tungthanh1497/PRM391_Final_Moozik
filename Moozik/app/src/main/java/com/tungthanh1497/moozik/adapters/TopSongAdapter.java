...
//    }
    ...
    public TopSongAdapter(List<SongModel> songModelList, Context context, FragmentActivity fragmentActivity) {
...
//        view.setOnClickListener(onClickListener);
    ...
    @Override
    public void onBindViewHolder(final TopSongViewHolder holder, final int position) {
...
//                ScreenManager.openFragment(fragmentActivity.getSupportFragmentManager(), new SongDetailFragment(), R.id.rl_layout_container);
    ...
    public class TopSongViewHolder extends RecyclerView.ViewHolder {
        ...
        public TopSongViewHolder(final View itemView) {
            super(itemView);
...
//                        ivAddToPlayList.setImageResource(R.drawable.icon_heart_tab_full);
